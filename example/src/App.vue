...
const items = [
    ...
    { value: 'autogenerate', text: 'Autogenerated Form from Data' }, 
...
export default {
  components: {
    autogenerate, simple, basic, async, grid, css, displayhelpers, deep, partial, multisourcedata, complex, treeview, arrayease, array, selection, selectiondynamic, conditional, list, pickers
  },
  data () {
    return {
      items,
