...
const doTheJob = async() => {
  ...
  dir = '../../../../../wotamann.github.io/vuetify/static';
  await fse.ensureDir(dir)
  ...
  await fse.copy('../../../../../wotamann.github.io/vuetify/static/index.html', '../../../../../wotamann.github.io/vuetify/static/404.html');
  console.log(`fse.copy('../../../../../wotamann.github.io/vuetify/static/index.html', '../../../../../wotamann.github.io/vuetify/static/404.html') ### finished ###`);
  
  dir = `../../../../../wotamann.github.io/vuetify/static`;
  const destDir = `../../../../../wotamann.github.io/vuetify`;
